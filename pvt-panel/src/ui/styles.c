...
lv_style_t *get_style_carrie_MAIN_DEFAULT() {
    ...
    if (!style) {
        ...
        lv_style_init(style);
        init_style_carrie_MAIN_DEFAULT(style);
    }
    return style;
};
...
void add_style_carrie(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_carrie_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_carrie(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_carrie_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};
